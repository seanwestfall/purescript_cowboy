...
var ordRenderingMode = new Data_Ord.Ord(function () {
    ...
    return function (y) {
        ...
        throw new Error("Failed pattern match at Ansi.Codes line 119, column 8 - line 119, column 54: " + [ x.constructor.name, y.constructor.name ]);
    };
});
...
var ordEraseParam = new Data_Ord.Ord(function () {
    ...
    return function (y) {
        ...
        throw new Error("Failed pattern match at Ansi.Codes line 82, column 8 - line 82, column 48: " + [ x.constructor.name, y.constructor.name ]);
    };
});
...
var ordColor = new Data_Ord.Ord(function () {
    ...
    return function (y) {
        ...
        throw new Error("Failed pattern match at Ansi.Codes line 151, column 8 - line 151, column 38: " + [ x.constructor.name, y.constructor.name ]);
    };
});
var ordGraphicsParam = new Data_Ord.Ord(function () {
    ...
    return function (y) {
        ...
        throw new Error("Failed pattern match at Ansi.Codes line 100, column 8 - line 100, column 54: " + [ x.constructor.name, y.constructor.name ]);
    };
});
var ordEscapeCode = new Data_Ord.Ord(function () {
    ...
    return function (y) {
        ...
        throw new Error("Failed pattern match at Ansi.Codes line 40, column 8 - line 40, column 48: " + [ x.constructor.name, y.constructor.name ]);
    };
});
