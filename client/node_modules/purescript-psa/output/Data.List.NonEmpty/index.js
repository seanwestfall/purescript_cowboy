    ...
    return function (f) {
        return function (v) {
            return function (v1) {
                ...
                throw new Error("Failed pattern match at Data.List.NonEmpty line 102, column 3 - line 104, column 81: " + [ v2.constructor.name ]);
            };
        };
    };
};
...
var wrappedOperation = function (name) {
    return function (f) {
        return function (v) {
            ...
            throw new Error("Failed pattern match at Data.List.NonEmpty line 89, column 3 - line 91, column 81: " + [ v1.constructor.name ]);
        };
    };
};
var updateAt = function (i) {
    return function (a) {
        return function (v) {
            ...
            throw new Error("Failed pattern match at Data.List.NonEmpty line 188, column 1 - line 188, column 75: " + [ i.constructor.name, a.constructor.name, v.constructor.name ]);
        };
    };
};
...
var unsnoc = function (v) {
    ...
    throw new Error("Failed pattern match at Data.List.NonEmpty line 150, column 35 - line 152, column 50: " + [ v1.constructor.name ]);
};
...
var modifyAt = function (i) {
    return function (f) {
        return function (v) {
            ...
            throw new Error("Failed pattern match at Data.List.NonEmpty line 193, column 1 - line 193, column 82: " + [ i.constructor.name, f.constructor.name, v.constructor.name ]);
        };
    };
};
...
var mapMaybe = function ($163) {
    return lift(Data_List.mapMaybe($163));
};
var partition = function ($164) {
    return lift(Data_List.partition($164));
};
var span = function ($165) {
    return lift(Data_List.span($165));
};
var take = function ($166) {
    return lift(Data_List.take($166));
};
var takeWhile = function ($167) {
    return lift(Data_List.takeWhile($167));
};
...
var intersectBy = function ($168) {
    return wrappedOperation2("intersectBy")(Data_List.intersectBy($168));
};
...
var insertAt = function (i) {
    return function (a) {
        return function (v) {
            ...
            if (Data_Boolean.otherwise) {
                return Data_Functor.map(Data_Maybe.functorMaybe)(function ($169) {
                    return Data_List_Types.NonEmptyList((function (v1) {
                        return new Data_NonEmpty.NonEmpty(v.value0, v1);
                    })($169));
                })(Data_List.insertAt(i - 1 | 0)(a)(v.value1));
            };
            throw new Error("Failed pattern match at Data.List.NonEmpty line 183, column 1 - line 183, column 75: " + [ i.constructor.name, a.constructor.name, v.constructor.name ]);
        };
    };
};
var init = function (v) {
...
var index = function (v) {
    return function (i) {
        ...
        throw new Error("Failed pattern match at Data.List.NonEmpty line 157, column 1 - line 157, column 52: " + [ v.constructor.name, i.constructor.name ]);
    };
};
var head = function (v) {
    return v.value0;
};
var groupBy = function ($170) {
    return wrappedOperation("groupBy")(Data_List.groupBy($170));
};
...
var fromList = function (v) {
    ...
    throw new Error("Failed pattern match at Data.List.NonEmpty line 118, column 1 - line 118, column 57: " + [ v.constructor.name ]);
};
var fromFoldable = function (dictFoldable) {
    return function ($171) {
        return fromList(Data_List.fromFoldable(dictFoldable)($171));
    };
};
...
var findLastIndex = function (f) {
    return function (v) {
        ...
        throw new Error("Failed pattern match at Data.List.NonEmpty line 177, column 3 - line 181, column 29: " + [ v1.constructor.name ]);
    };
};
var findIndex = function (f) {
    return function (v) {
        ...
        throw new Error("Failed pattern match at Data.List.NonEmpty line 170, column 1 - line 170, column 69: " + [ f.constructor.name, v.constructor.name ]);
    };
};
var filterM = function (dictMonad) {
    return function ($172) {
        return lift(Data_List.filterM(dictMonad)($172));
    };
};
var filter = function ($173) {
    return lift(Data_List.filter($173));
};
...
var dropWhile = function ($174) {
    return lift(Data_List.dropWhile($174));
};
var drop = function ($175) {
    return lift(Data_List.drop($175));
};
var cons = function (y) {
    return function (v) {
