            ...
            var extendJObj = function (obj) {
                return function (k) {
                    return Control_Bind.bind((dictMonadGen.Monad0()).Bind1())(genJson(dictMonadGen)(dictMonadRec)(dictLazy))(function (v) {
                        return Control_Applicative.pure((dictMonadGen.Monad0()).Applicative0())(Data_Argonaut_Core.caseJsonObject(Data_Argonaut_Core.jsonSingletonObject(k)(v))(function ($8) {
                            return Data_Argonaut_Core.fromObject(Foreign_Object.insert(k)(v)($8));
                        })(obj));
                    });
                };
            };
