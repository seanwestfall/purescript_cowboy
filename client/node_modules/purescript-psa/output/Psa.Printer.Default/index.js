...
var toLines = function ($38) {
    return Psa_Printer.para(Data_Functor.map(Data_Functor.functorArray)(function ($39) {
        return Psa_Printer.line(Data_Array.singleton(Psa_Printer.plain($39)));
    ...
    return function (col2) {
        return function (col3) {
            return function (col4) {
                var lineLength = function ($40) {
                    return Data_Foldable.sum(Data_Foldable.foldableArray)(Data_Semiring.semiringInt)(Data_Functor.map(Data_Functor.functorArray)(Psa_Printer.ansiLength)($40));
                };
...
var renderVerboseStats = function (stats) {
    ...
    var warningLabels = Data_Functor.map(Data_Functor.functorArray)(function ($41) {
        return Data_Array.singleton(Psa_Printer.style(Ansi_Output.foreground(Ansi_Codes.Yellow.value))($41));
    })(warnings);
    ...
    var errorLabels = Data_Functor.map(Data_Functor.functorArray)(function ($42) {
        return Data_Array.singleton(Psa_Printer.style(Ansi_Output.foreground(Ansi_Codes.Red.value))($42));
    })(errors);
