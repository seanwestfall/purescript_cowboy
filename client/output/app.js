                  ...
                  if (v instanceof Bind) {
                      return Data_Exists.runExists(function (v1) {
                          return bound(v1.value0)((function () {
                              var $121 = Data_Functor.map(functorFreeT(dictFunctor)(dictFunctor1))(f);
                              return function ($122) {
                                  return $121(v1.value1($122));
                              };
                          })());
                      })(v.value0);
                  };
                  throw new Error("Failed pattern match at Control.Monad.Free.Trans (line 58, column 1 - line 60, column 71): " + [ f.constructor.name, v.constructor.name ]);
              };
          });
      };
  };
      ...
      return function (dictMonadRec) {
          return function (interp) {
              var go = function (v) {
                  ...
                  throw new Error("Failed pattern match at Control.Monad.Free.Trans (line 137, column 3 - line 137, column 63): " + [ v.constructor.name ]);
              };
...
(function($PS) {
  ...
  var handleAction = function (v) {
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.document)(Web_HTML.window)))(function (v1) {
              return Halogen_Query_HalogenM["subscribe'"](function (sid) {
                  return Halogen_Query_EventSource.eventListenerEventSource(Effect_Aff_Class.monadAffAff)(Web_UIEvent_KeyboardEvent_EventTypes.keyup)(Web_HTML_HTMLDocument.toEventTarget(v1))((function () {
                      var $25 = Data_Functor.map(Data_Maybe.functorMaybe)(HandleKey.create(sid));
                      return function ($26) {
                          return $25(Web_UIEvent_KeyboardEvent.fromEvent($26));
                      };
                  })());
              });
          });
      ...
      if (v instanceof HandleKey) {
          if (Web_UIEvent_KeyboardEvent.shiftKey(v.value1)) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value1))))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                      ...
                      $12.spriteHero = "sprite-hero-gun" + (function () {
          ...
          if (Web_UIEvent_KeyboardEvent.code(v.value1) === "ArrowLeft") {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $16.spriteStyle = "position: absolute; left: " + (Data_Show.show(Data_Show.showInt)(state.spritePosition) + "px;");
                  $16.spritePosition = state.spritePosition - 10 | 0;
                  $16.spriteIndex = (function () {
                      var $15 = state.spriteIndex !== 3;
                      if ($15) {
                          return state.spriteIndex + 1 | 0;
                      };
                      return 0;
                  })();
                  $16.spriteReverse = true;
                  $16.spriteHero = "sprite-hero-" + (Data_Show.show(Data_Show.showInt)(state.spriteIndex) + "r");
                  return $16;
              }))(function (v1) {
          ...
          if (Web_UIEvent_KeyboardEvent.code(v.value1) === "ArrowRight") {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $20.spriteStyle = "position: absolute; left: " + (Data_Show.show(Data_Show.showInt)(state.spritePosition) + "px;");
                  $20.spritePosition = state.spritePosition + 10 | 0;
                  $20.spriteIndex = (function () {
                      var $19 = state.spriteIndex !== 3;
                      if ($19) {
                          return state.spriteIndex + 1 | 0;
                      };
                      return 0;
                  })();
                  $20.spriteReverse = false;
                  $20.spriteHero = "sprite-hero-" + Data_Show.show(Data_Show.showInt)(state.spriteIndex);
                  return $20;
              }))(function (v1) {
      ...
      throw new Error("Failed pattern match at Component (line 87, column 16 - line 124, column 18): " + [ v.constructor.name ]);
  };
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Hello Cowboy") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("inner"), Halogen_HTML_Properties.attr("style")(state.innerStyle) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(state.spriteHero), Halogen_HTML_Properties.attr("style")(state.spriteStyle) ])([  ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("instructions"), Halogen_HTML_Properties.attr("style")("display: block; position: fixed; margin-top: 200px;") ])([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Tap the Left or Right Arrow keys to make the cowboy walk.") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Hit the Shfit key plux any other key to make the cowboy hold up his gun.") ]) ]) ]);
      };
